(function (root, factory) {
    ...
    var beforeAfter = function ( options ) {
        ...
        if (typeof(settings.before) == 'object') {
            ...
            var wid = document.querySelector('.galeria-wrapper').getBoundingClientRect().width + 30 + 'px';

            images[0].onload = function() {
                //arma segun la pagina
                //container.style.width = this.width + 'px';
                container.style.width = wid;
                images[0].style.width = wid;
            };
            images[1].onload = function() {
                images[1].style.width = wid;
            };
